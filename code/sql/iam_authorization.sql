...
INSERT INTO `authorization` VALUES (4,'read','Manager',NULL),(5,'read','Doctor','<policy><rule> subject.ID = object.DoctorID</rule></policy>'),(6,'read',NULL,'<policy><rule> subject.ID = object.PatientID</rule></policy>');
